...
#scenario1
#zuul.routes.userapi.url=http://localhost:8089
#zuul.routes.userapi.path=/userapi/**

#scenario2
ribbon.eureka.enabled=false
zuul.routes.userapi.path=/userapi/**
zuul.routes.userapi.serviceId=proxy
proxy.ribbon.listOfServers=http://localhost:8089


#scenario3
#no configuration needed for eureka. go to /servicename/


#scenairo4
#zuul.ignoredServices=*
zuul.routes.userapi.path=/userapi/**
zuul.routes.userapi.serviceId=proxy-userapi-service
zuul.ignoredPatterns=/userapi/adduser/1


#scenario5 prepend everything with /api
zuul.prefix=/api
