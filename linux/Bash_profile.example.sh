...
#  9.  Reminders & Notes
# 10. PHP CLI Alias
# 11. Laravel CLI Comands
# 12. Composer CLI Comands
# 13. Vagrent & Homested commands CLI Comands
#
#  ---------------------------------------------------------------------------
...
#   -----------------------------
    ...
    alias editBashProfile='edit ~/.bash_profile'          #.bash:         open .bash_profile in editor
    alias srcBash='source .bash_profile'        #Source .bash_profile
...
#   10. PHP CLI Alias
#   -----------------------------------
    alias phpunit="vendor/bin/phpunit"      #Run PHP Unit test
#   ----------------------------------
#   11. Laravel CLI Comands
#   ----------------------------------
...
#   13. Vagrent & Homested commands CLI Comands
#   ----------------------------------
    vm(){(cd ~/Homestead && vagrant $*)}   #Use vm command to do vagrent operations from anywhere.

    alias editHomestead='edit ~/.homestead/Homestead.yaml' #edit Homestead.yaml file

#   ------------------------------------
#   Go Straigt to faverate ripo
#   -------------------------------------
